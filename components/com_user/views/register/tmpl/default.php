...
<tr>
	<td width="30%" height="40">
		<label id="lnamemsg" for="lname">
			<?php echo JText::_( 'Lname' ); ?>:
		</label>
	</td>
  	<td>
  		<input type="text" name="last_name" id="last_name" size="40" value="<?php echo $this->escape($this->user->get( 'last_name' ));?>" class="inputbox required" maxlength="50" /> *
  	</td>
</tr>
<tr>
	<td height="40">
