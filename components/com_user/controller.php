...
class UserController extends JController
{
	...
	function save()
	{
		...
		$post['last_name']	= JRequest::getVar('last_name', '', 'post', 'last_name');
	...
	function login()
	{
		...
		$credentials['front'] = true;
		$credentials['email'] = JRequest::getVar('username', '', 'method', 'username');
	...
	function _sendMail(&$user, $password)
	{
		...
		if ( $useractivation == 1 ){
			$message = sprintf ( JText::_( 'SEND_MSG_ACTIVATE' ), $name, $sitename, $siteURL."index.php?option=com_user&task=activate&activation=".$user->get('activation'), $siteURL, $email, $password);
		} else {
