...
// Access check.
if (!JFactory::getUser()->authorise('core.manage', 'com_mcm')){
...
foreach($controllers as $controller){
	...
	JSubMenuHelper::addEntry(JText::_( 'MENU' . $controller ), "index.php?option=com_mcm&controller={$controller}", ($controller == JRequest::getWord('controller')));
}
