...
// mcm code 
		...
		$data['quicktake'] = JRequest::getVar('quicktake', '', 'post', 'string', JREQUEST_ALLOWRAW);
		...
		$data['smoking'] = JRequest::getVar('smoking', '', 'post', 'int');
		$data['avg_dinner_price'] = JRequest::getVar('avg_dinner_price', '', 'post', 'int');
