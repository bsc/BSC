		...
		<legend><?php echo JText::_( 'User Details' ); ?></legend>
			<table class="admintable" cellspacing="1">
				...
				<tr>
					<td width="150" class="key">
						<label for="last_name">
							<?php echo JText::_( 'Lname' ); ?>
						</label>
					</td>
					<td>
						<input type="text" name="last_name" id="last_name" class="inputbox" size="40" value="<?php echo $this->user->get('last_name'); ?>" />
					</td>
				</tr>
				<tr style="display: none">
					...
					<td>
						<input type="text" name="username" id="username" class="inputbox" size="40" value="<?php echo "tempuser" ; ?>" autocomplete="off" />
					</td>
				</tr> 
				<tr>
					<td class="key">
