<?php
/**
 * @version		$Id: controllerform.php 552 2011-01-18 23:05:49Z eddieajau $
...
class JControllerForm extends JController
{
	...
	public function save($key = null)
	{
		...
		// Note, mirror change from 1.6 due to changes in JTable.
		if ($checkin && $validData[$key] && $model->checkin($validData[$key]) === false) {
			// Save the data in the session.
			$app->setUserState($context.'.data', $validData);
