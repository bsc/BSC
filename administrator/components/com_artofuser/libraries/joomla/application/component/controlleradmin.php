<?php
/**
 * @version		$Id: controlleradmin.php 523 2011-01-12 05:42:06Z eddieajau $
...
//				$this->setMessage(JText::plural($this->text_prefix.'_N_ITEMS_DELETED', count($cid)));
				$this->setMessage(JText::sprintf($this->text_prefix.'_N_ITEMS_DELETED', count($cid)));
			} else {
...
//				$this->setMessage(JText::plural($ntext, count($cid)));
				$this->setMessage(JText::sprintf($ntext, count($cid)));
			}
		}
...
//			$message =  JText::plural($this->text_prefix.'_N_ITEMS_CHECKED_IN', count($ids));
			$message =  JText::sprintf($this->text_prefix.'_N_ITEMS_CHECKED_IN', count($ids));
			$this->setRedirect(JRoute::_('index.php?option='.$this->option.'&view='.$this->view_list, false), $message);
			return true;
		}
	}
