<?php
/**
 * @version		$Id: form.php 352 2010-10-26 08:52:42Z eddieajau $
...
class JForm extends JObject
{
	...
	public function validate($data, $limit = null)
	{
		...
		juimport('jxtended.form.formvalidator');
	...
	public function loadFieldsXML(&$xml, $reset = true)
	{
		...
		if ($xml->attributes('addfieldpath'))
		{
			jimport('joomla.filesystem.folder');
			jimport('joomla.filesystem.path');
			$path = JPath::clean(JPATH_ROOT.'/'.$xml->attributes('addfieldpath'));
	...
	public static function addFormPath($new = null)
	{
		...
		if (!isset($paths)) {
			$paths = array(dirname(__FILE__).'/forms');
		}
	...
	public static function addFieldPath($new = null)
	{
		...
		if (!isset($paths)) {
			$paths = array(dirname(__FILE__).'/fields');
		}
